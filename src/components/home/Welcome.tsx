    ...
    <section className="px-6 py-8 flex flex-col justify-center items-center">
      <div className="max-w-4xl">
        ...
        <p className="py-4 text-center">
          ...
          creative, and world-changing. We&apos;re passionate about building a Church that doesn&apos;t 
          just gather on Sundays but steps out to influence schools, workplaces, neighbourhoods, and cities. 
          Our prayer is that as you flip through these pages, you&apos;ll catch a glimpse of the future God 
          is writing and realize you&apos;re invited to be part of it.
        </p>
      </div>
    </section>
  );
