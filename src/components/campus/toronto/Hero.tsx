      ...
      <div className="relative h-[42rem] overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center">
          ...
          <Image
            ...
            className="mt-[-6em]"
          />
          <h1 className="text-white font-bold text-5xl md:text-5xl mt-5">TORONTO</h1>

          <div className="flex flex-wrap justify-center space-x-6 mt-6 text-white text-2xl">
            <a href="https://www.facebook.com/profile.php?id=61556487224342" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
            ...
            <a href="https://www.instagram.com/avantlifetoronto/" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
